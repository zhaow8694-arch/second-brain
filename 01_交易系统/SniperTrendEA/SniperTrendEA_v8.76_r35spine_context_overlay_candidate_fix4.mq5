...
//+------------------------------------------------------------------+
#property copyright "SniperTrendEA v8.76 fix4 - r35 Spine + Common Decision Log Overlay"
...
input string InpComment        = "SniperEA_v8.76_r35fix4";
...
int OnInit()
{
   ...
   Print("SniperTrendEA v8.76_r35spine_fix4 初始化成功 | ", _Symbol, " ", EnumToString(Period()),
         " | 预设:", g_presetName,
