...
input string InpComment = "SniperEA_v8.70_spread_governor";
...
const string EA_VERSION_NAME      = "SniperTrendEA_v8.70_spread_cost_governor_candidate";
               ...
               adxOk && timeOk && atrFilterOk && (!InpUseDailyFilter || dailyUp))
            {
               ...
               else
               {
                  ...
                  else
                  {
                     ...
                     bool strong_context = true;
                     if(!ApplySpreadCostGovernor(lot, strong_context))
                     {
                        g_pendingBuy = false; g_pendingBars = 0;
                     }
                     else
