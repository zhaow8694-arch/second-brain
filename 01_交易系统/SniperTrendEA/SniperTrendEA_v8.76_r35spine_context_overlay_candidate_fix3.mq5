...
//+------------------------------------------------------------------+
#property copyright "SniperTrendEA v8.76 fix3 - r35 Spine + Profit-Spine Protected Context Overlay"
...
input string InpComment        = "SniperEA_v8.76_r35fix3";
...
int OnInit()
{
   ...
   Print("SniperTrendEA v8.76_r35spine_fix3 初始化成功 | ", _Symbol, " ", EnumToString(Period()),
         " | 预设:", g_presetName,
