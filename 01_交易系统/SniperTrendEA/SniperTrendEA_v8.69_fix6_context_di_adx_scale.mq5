...
input group "=== v8.69 fix6 Context DI/ADX Soft Scale ==="
input bool   InpUseV869ContextScale = false;
input double InpV869ContextLotScale = 0.25;
input int    InpV869ContextMode = 1; // 0=weak DI, 1=weak DI + low ADX, 2=low ADX
...
int OnInit()
{
   ...
   if(InpUseV869RegimeGate || InpV869EntryDiagnosticLog || InpUseV869DiEdgeHourGate || InpUseV869DiEdgeHourScale || InpUseV869ResidualHourScale || InpUseV869ContextScale)
   {
