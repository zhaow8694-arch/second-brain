...
input string InpComment = "SniperEA_v8.69_fix4c";
...
const string EA_VERSION_NAME      = "SniperTrendEA_v8.69_fix4c_loss_armed_time_gate";
...
bool IsV869TimeClusterBlocked(bool forBuy)
{
   ...
   {
      Print("[v8.69_fix4c TimeGate] blocked ",
            (forBuy ? "BUY" : "SELL"),
