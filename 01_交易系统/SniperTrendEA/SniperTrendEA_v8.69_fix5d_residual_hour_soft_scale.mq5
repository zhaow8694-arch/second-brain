...
input string InpComment = "SniperEA_v8.69_fix5d";
...
const string EA_VERSION_NAME      = "SniperTrendEA_v8.69_fix5d_loss_armed_time_gate";
...
int OnInit()
{
   ...
   if(InpUseV869RegimeGate || InpV869EntryDiagnosticLog || InpUseV869DiEdgeHourGate || InpUseV869DiEdgeHourScale || InpUseV869ResidualHourScale)
   {
               ...
               adxOk && timeOk && atrFilterOk && (!InpUseDailyFilter || dailyUp))
            {
               ...
               else
               {
                  ...
                  else
                  {
                     ...
                     double rawLot = CalculateLotSize(ep - sl) * structureFactor * GetV869DiEdgeHourLotScale(true) * GetV869ResidualHourLotScale(true);
               ...
               adxOk && timeOk && atrFilterOk && (!InpUseDailyFilter || dailyDown))
            {
               ...
               else
               {
                  ...
                  else
                  {
                     ...
                     double rawLot = CalculateLotSize(sl - ep) * structureFactor * GetV869DiEdgeHourLotScale(false) * GetV869ResidualHourLotScale(false);
                     double lot = (rawLot > 0.0 ? AdjustLotSize(rawLot) : 0.0);
