...
input string InpComment = "SniperEA_v8.71_real_context";
...
const string EA_VERSION_NAME      = "SniperTrendEA_v8.71_real_strong_context_candidate";
...
int OnInit()
{
   ...
   if(InpUseV869RegimeGate || InpV869EntryDiagnosticLog || InpUseV869DiEdgeHourGate || InpUseV869DiEdgeHourScale || InpUseV869ResidualHourScale || InpUseV869ContextScale || InpUseV871RealStrongContext)
   {
