...
//+------------------------------------------------------------------+
#property copyright "SniperTrendEA v8.76 r35base - v8.6 Spine + Context Overlay"
...
input string InpComment        = "SniperEA_v8.76_r35base";
...
input string InpV876DecisionLogFile         = "v876_r35base_context_overlay_decisions.csv";
...
int OnInit()
{
   ...
   Print("SniperTrendEA v8.76 r35base 鍒濆鍖栨垚鍔?| ", _Symbol, " ", EnumToString(Period()),
         " | 棰勮:", g_presetName,
      ...
      if(g_pendingBuy || g_pendingSell)
      {
         ...
         else
         {
                ...
                structureOk)
            {
               ...
               {
                  Print("銆愮粨鏋勮繃婊?澶氥€戞湭閫氳繃锛屼繚鐣檖ending | score:", DoubleToString(structureInfo.score, 1));
               }
                ...
                structureOk)
            {
               ...
               {
                  Print("銆愮粨鏋勮繃婊?绌恒€戞湭閫氳繃锛屼繚鐣檖ending | score:", DoubleToString(structureInfo.score, 1));
               }
               else if(!IsSpreadAcceptable())
               {
