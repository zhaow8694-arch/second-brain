...
void ClosePosition(ulong ticket)
{
   ...
   //--- 自动适配品种支持的成交模式
   long fillModeClose = SymbolInfoInteger(_Symbol, SYMBOL_FILLING_MODE);
   if((fillModeClose & SYMBOL_FILLING_FOK) == SYMBOL_FILLING_FOK)
      req.type_filling = ORDER_FILLING_FOK;
   else if((fillModeClose & SYMBOL_FILLING_IOC) == SYMBOL_FILLING_IOC)
      req.type_filling = ORDER_FILLING_IOC;
   else
      req.type_filling = ORDER_FILLING_RETURN;
