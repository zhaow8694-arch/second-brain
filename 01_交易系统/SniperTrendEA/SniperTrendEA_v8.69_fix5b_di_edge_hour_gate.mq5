...
input string InpComment = "SniperEA_v8.69_fix5b";
...
const string EA_VERSION_NAME      = "SniperTrendEA_v8.69_fix5b_loss_armed_time_gate";
...
int OnInit()
{
   ...
   if(InpUseV869RegimeGate || InpV869EntryDiagnosticLog || InpUseV869DiEdgeHourGate)
   {
...
bool IsV869DiEdgeHourBlocked(bool forBuy)
{
   ...
   {
      Print("[v8.69_fix5b DiEdgeGate] blocked ",
            (forBuy ? "BUY" : "SELL"),
            " hour=", dt.hour,
...
bool IsV869TimeClusterBlocked(bool forBuy)
{
   ...
   {
      Print("[v8.69_fix5b TimeGate] blocked ",
            (forBuy ? "BUY" : "SELL"),
