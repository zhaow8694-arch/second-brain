...
//+------------------------------------------------------------------+
#property copyright "SniperTrendEA v8.76 - r35 Profit Spine + Selective Context Overlay"
...
input string InpComment        = "SniperEA_v8.76_r35spine";
...
void OnTick()
{
   ...
   if(InpDebugMode)
   {
      ...
      Comment("SniperEA v8.76_r35spine | 预设:", g_presetName, " | ", _Symbol, " ", EnumToString(Period()), "\n",
...
ENUM_V876_CONTEXT_CLASS ClassifyV876Context(SV876Decision &d)
{
   ...
   if(cleanCandle && profitBody && acceptableWick)
...
bool ApplyV876ExecutionCostGuard(SV876Decision &d)
{
   ...
   d.finalLot = AdjustLotSize(d.finalLot * d.spreadLotScale);
