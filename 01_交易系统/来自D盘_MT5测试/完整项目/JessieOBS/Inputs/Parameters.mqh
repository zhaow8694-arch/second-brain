...
input int      InpStateSwitchBars    = 8;         // 状态切换最小K线数
input double   InpStateConfidenceReq = 75.0;      // 状态切换置信度要求(%)
...
input int      InpTrendMinADX        = 18;        // 趋势策略最低ADX
input int      InpTrendCooldownBars  = 2;         // 趋势策略冷却K线数
