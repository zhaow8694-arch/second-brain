...
#include "Stg_Meta_Volatility.mqh"

// Defines.
#define ea_name "Strategy Meta Volatility"
#define ea_version "2.000"
#define ea_desc "Volatility meta strategy to trade with different strategies based on the current market volatility."
#define ea_link "https://github.com/EA31337/Strategy-Meta_Volatility"
...
int OnInit() {
  ...
  ea = new EA(ea_params);
  _result &= ea.StrategyAdd<Stg_Meta_Volatility>(Active_Tfs);
