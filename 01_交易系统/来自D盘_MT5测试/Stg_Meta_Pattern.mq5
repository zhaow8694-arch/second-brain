...
#include "Stg_Meta_Pattern.mqh"

// Defines.
#define ea_name "Strategy Meta Pattern"
#define ea_version "2.000"
#define ea_desc "Pattern meta strategy to trade with different strategies based on the current daily pattern."
#define ea_link "https://github.com/EA31337/Strategy-Meta_Pattern"
...
int OnInit() {
  ...
  ea = new EA(ea_params);
  _result &= ea.StrategyAdd<Stg_Meta_Pattern>(Active_Tfs);
