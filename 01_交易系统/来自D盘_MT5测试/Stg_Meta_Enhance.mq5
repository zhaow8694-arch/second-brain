...
#include "Stg_Meta_Enhance.mqh"

// Defines.
#define ea_name "Strategy Meta Enhance"
#define ea_version "2.000"
#define ea_desc "Enhance meta strategy reverses signals of another strategy."
#define ea_link "https://github.com/EA31337/Strategy-Meta_Enhance"
...
int OnInit() {
  ...
  ea = new EA(ea_params);
  _result &= ea.StrategyAdd<Stg_Meta_Enhance>(Active_Tfs);
