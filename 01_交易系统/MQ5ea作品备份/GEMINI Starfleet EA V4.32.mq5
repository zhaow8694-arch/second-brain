...
input double   InpRiskPercent       = 1.0;   //【1号架构师钢印：机皇参数】
input double   InpDailyDrawdownLimit = 3.0;
input int      InpAtrPeriod         = 14;
input double   InpAtrMultiplier     = 3.0;   //【1号架构师钢印：机皇参数】
input double   InpAtrDeadZone       = 0.5;
input int      InpDonchianPeriod    = 35;    //【1号架构师钢印：机皇参数】
input double   InpAdxThreshold      = 24.0;  //【1号架构师钢印：机皇参数】
