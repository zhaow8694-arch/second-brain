...
#property description "Risk management with dynamic lot sizing and daily drawdown protection"
...
input int      InpStartHour      = 21;            // 交易开始小时 (北京时间适配需注意 MT5 服务器时间)
input int      InpEndHour        = 2;             // 交易结束小时
